...
function patch(auth, dim, identifier, body) {
  return wFetch(`${dimensionUrl()}/${dim}`, "PATCH", auth, identifier, body);
}

function post(auth, dim, identifier, body) {
  return wFetch(`${dimensionUrl()}/${dim}`, "POST", auth, identifier, body);
}

function Delete(auth, dim, identifier) {
  return wFetch(`${dimensionUrl()}/${dim}`, "DELETE", auth, identifier);
}
